...
class ResponsiveScaffold extends StatefulWidget {
  ...
  final Widget? menuLeadingAvatar;
...
class _ResponsiveScaffoldState extends State<ResponsiveScaffold> {
  ...
  void didUpdateWidget(covariant ResponsiveScaffold oldWidget) {
    ...
    if (media.size != _mediaSize) {
      _mediaSize = media.size;
    ...
    if (widget.menuItemsEnabled != null) {
      if (widget.menuItemsEnabled != oldWidget.menuItemsEnabled &&
        ...
        _menuItemsEnabled = widget.menuItemsEnabled!;
      }
    }
    if (widget.menuItemsIconState != null) {
      if (widget.menuItemsIconState != oldWidget.menuItemsIconState &&
        ...
        _menuItemsIconState = widget.menuItemsIconState!;
      }
    }
  }
  ...
  void initState() {
    ...
    _activeMenuWidth = widget.menuWidth;
    ...
    _menuItemsIconState = List<ResponsiveMenuItemIconState>.generate(
  ...
  Widget build(BuildContext context) {
    ...
    if (!isDesktop && !_isMenuClosed) _activeMenuWidth = widget.railWidth;
    if (isDesktop && !_isMenuExpanded) _activeMenuWidth = widget.railWidth;
    if (isDesktop && _isMenuExpanded) _activeMenuWidth = widget.menuWidth;
      ...
      children: <Widget>[
        ...
        ConstrainedBox(
          ...
          child: Material(
            ...
            child: AnimatedContainer(
              ...
              width: _activeMenuWidth,
              child: _AppMenu(
                title: widget.menuTitle,
                menuLeadingTitle: widget.menuLeadingTitle,
                menuLeadingSubtitle: widget.menuLeadingSubtitle,
                menuLeadingAvatarLabel: widget.menuLeadingAvatar,
                menuItems: widget.menuItems,
                menuItemsEnabled: _menuItemsEnabled,
                menuItemsIconState: _menuItemsIconState,
        ...
        Expanded(
          child: Scaffold(
            ...
            drawerEnableOpenDragGesture: !isDesktop && _isMenuClosed,
                        ...
                        children: <Widget>[
                          ...
                          for (int i = 0; i < widget.menuItems.length; i++)
                            _MenuItem(
                              ...
                              showDivider: widget.menuItems[i].showDivider,
                              railWidth: widget.railWidth,
                            ),
    ...
    return Column(
      children: <Widget>[
        ListTile(
          ...
          leading: widget.menuLeadingAvatarLabel,
